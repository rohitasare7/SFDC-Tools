...
<template>
  ...
  <div class="container mx-auto p-4">
    <PageTitle class="text-2xl font-bold text-center">Random Data Generator</PageTitle>
    <InputLabel class="text-normal font-thin text-center">Generates random data for your Unit Testing</InputLabel>
  ...
  <div class="container mx-auto pb-4">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 p-4 md:p-0 mt-2">
      <div v-for="(item, key) in randomData" :key="key"
        class="p-6 bg-gray-100 border border-gray-200 rounded-lg dark:shadow-2xl dark:bg-gray-800 dark:border-gray-700">
