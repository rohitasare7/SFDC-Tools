    ...
    navItems: [
        {
            route: '/dashboard', active: false, name: 'Salesforce Tools', icon: CloudIcon, children: [
                { route: '/tools/comma-inserter', active: false, name: 'Execute Code', children: [], icon : CodeBracketIcon },
                { route: '/tools/debug/utility', active: false, name: 'Debug Utiliy', children: [], icon : SquaresPlusIcon},
